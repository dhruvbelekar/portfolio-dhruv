...
/*
  What the work above was actually made with, in the logos Dhruv supplied.
  Each one is the tool's own icon at its own colours, so the row is a shelf of
  applications rather than a set of matched marks.
*/
export type Tool = {
  name: string;
  mark?: string;
